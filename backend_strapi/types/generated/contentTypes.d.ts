...
export interface ApiCsTheoryCsTheory extends Schema.CollectionType {
...
export interface ApiProgLangProgLang extends Schema.CollectionType {
...
export interface ApiStudyNoteStudyNote extends Schema.CollectionType {
  ...
  attributes: {
    ...
    front_frames: Attribute.Relation<
      ...
      'api::front-frame.front-frame'
    >;
    cs_theories: Attribute.Relation<
      'api::study-note.study-note',
      'manyToMany',
      'api::cs-theory.cs-theory'
    >;
