...
export default function Home() {
  return (
    <div className={styles.home}>
      ...
      chung dưới cái tên bao trùm "Technical Art", các bạn học viên đều có thể
      vững chãi tin rằng những lớp Art của DPGP xưa nay và trong tương lai vẫn
      tập trung vào khía cạnh thẩm mỹ và kỹ năng hội hoạ căn bản, nội dung được
      xây dựng bởi Artists và dành cho Artists, không khác gì các chương trình
      mỹ thuật chính thống.
      <br />
      <br />
      ...
      duy: là tổng kết những gì ta hiểu về sự vật, hiện tượng, và thế giới. Cũng
      từ đó, DPGP tin rằng khát khao lẫn tiềm tàng sáng tạo của một người hoạ sĩ
      thời hiện đại còn có thể biểu đạt qua rất nhiều hình thái khác: bao gồm
      những bộ môn nằm trong chữ "Tech" bên trong "TechArt".
      <br />
      <br />
      ...
      Anatomy, mà sau khi hiểu rõ trước tiên về bộ máy cơ thể con người, cả một
      chân trời nay đã mở ra: không chỉ là Animation, Rigging, lập trình, nhưng
      là khả năng và nỗ lực tìm hiểu tường tận những thứ mà chúng ta mong muốn,
      là óc tư duy phân tích, là kỹ năng tổng hợp vấn đề.
      <br />
      <br />
      ...
      tìm hiểu, là những phẩm chất càng quý báu trong thời đại hôm nay.
      <br />
      <br />
      ...
      của mình cả. Trái lại, những người còn giữ ám ảnh "battle of Tech versus
      Art" (cuộc chiến của nghệ thuật đối lập với kỹ thuật hay công nghệ) mới
      chính là những người dễ có tư duy hạn hẹp đó chứ: Sử dụng nhuần nhuyễn kỹ
